...
adhere to. This dataset contains 9 different types of contrains:

-   One-of: TBA @nicolas

-   Single-Value: TBA @nicolas

-   ConflictsWith: TBA @nicolas

-   Distinct values: TBA @nicolas

-   Inverse: TBA @nicolas

-   ValueRequiresStatem: TBA @nicolas

-   ValueType: TBA @nicolas

-   Type: TBA @nicolas

-   ItemRequiresStatement: TBA @nicolas
